...
import { Play, AlertTriangle, Subtitles, Server, Loader2, CheckCircle, XCircle, Maximize, Minimize } from "lucide-react";
  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        className={`relative bg-black rounded-xl ${isFullscreen ? "w-screen h-screen" : "aspect-video"}`}
      >
        <iframe
          key={activeServer}
          src={embedUrl}
        ...
        <button
          ...
          className="absolute bottom-3 right-3 z-30 p-1.5 bg-black/60 hover:bg-black/80 text-white rounded transition-colors"
          title={isFullscreen ? "Keluar fullscreen" : "Fullscreen dengan subtitle"}
        >
